...
Quando comecei com o *desenvolvimento de jogos* usando *SDL2*, uma das minhas maiores dificuldades era instalar a *lib de desenvolvimento* no *Linux*, como a maioria dos tutoriais eram dominados pelo *Windows*, tive que passa um bom tempo dando uma bela procurada no nosso querido *Stack Overflow*, criei este guia para agilizar as coisas.
